...
import { RawIntlProvider, createIntl, createIntlCache } from '/Users/thienvu/Documents/Projects/Community/designable/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from '/Users/thienvu/Documents/Projects/Community/designable/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/thienvu18/designable/edit/main/{filename}";

    localeMessages['$internal.api.sourceLink'] = "https://github.com/thienvu18/designable/tree/main/{fileName}#L{line}";
